...
C_FLAGS="${C_FLAGS} -I/bulk/workbench/llvm-openmp/toolchain1/include/"
...
LINKER_FLAGS="${LINKER_FLAGS} -Wl,-L/bulk/workbench/llvm-openmp/toolchain1/lib/"

#

PIPELINES="genbc;linkbc;optlvl2_custom;binarybc"
COMPOUND_PIPELINES="group1"
GROUP1_PIPELINE="genbc;linkbc;optlvl2_custom;binarybc"
