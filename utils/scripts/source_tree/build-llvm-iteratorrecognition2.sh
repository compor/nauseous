...
PIPELINES="genbc;linkbc;loopc14n;pedigree;iteratorrecognition;binarybc"
COMPOUND_PIPELINES="group1"
GROUP1_PIPELINE="genbc;linkbc;loopc14n;iteratorrecognition;pedigree;binarybc"
...
cmake \
  ...
  -Diteratorrecognition_DIR=${ITERATORRECOGNITION_DIR} \
  -Dpedigree_DIR=${PEDIGREE_DIR} \
