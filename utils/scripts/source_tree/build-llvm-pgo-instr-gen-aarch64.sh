...
#C_FLAGS="${C_FLAGS} -Wl,/media/fast/chrvas01/llvm/6.0/compiler-rt-aarch64/lib/linux/libclang_rt.profile-aarch64.a"

PGO_FLAGS=""
PGO_FLAGS="${PGO_FLAGS} -fprofile-instr-generate=data.prof"

C_FLAGS="${C_FLAGS} ${PGO_FLAGS}"
