...
C_FLAGS="${C_FLAGS} -mllvm -slp-threshold=-1000000"
...
PIPELINES="genbc;linkbc;loopc14n;pollyalt1fastmath;binarybc"
COMPOUND_PIPELINES="group1"
GROUP1_PIPELINE="genbc;linkbc;loopc14n;pollyalt1fastmath;binarybc"
